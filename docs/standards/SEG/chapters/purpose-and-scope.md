...
- **Technical Documentation:** Formatting conventions for documenting Unity C# scripts, GameObjects, Prefabs, and architecture (e.g., Mermaid diagrams).
- **Lore and Narrative:** Guidelines for maintaining consistent terminology for in-game characters, worlds, items, and story elements.
- **Governance Records:** Formatting requirements for Work Orders and Change Requests.

### 1.2.1 Exclusions
This standard does NOT govern the actual C# coding conventions used inside the Unity engine (e.g., brace placement in scripts). It only governs how those elements are *written about* within the markdown documentation.
...
## 1.5 Conformance
A document is considered conformant to the SEG if it strictly adheres to the formatting, keyword usage, and naming conventions defined in the subsequent chapters.
