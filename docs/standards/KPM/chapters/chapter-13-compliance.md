...
| Criterion | Required |
|-----------|----------|
| Canonical Package Structure | Yes |
| Complete Metadata | Yes |
| Valid Package Manifest | Yes |
| Valid Knowledge Assets | Yes |
| Approved Governance | Yes |
| Valid Lifecycle State | Yes |
| Successful Validation | Yes |
| Publication Eligibility | Yes |
...
| Conditionally Compliant | Minor approved deviations |
