...
## Title
Standards Governance Model (SGM)

## Document Information
- **Edition:** 1
- **Version:** v0.2.0
- **Status:** Release Candidate 1 (RC-1) Ready
...
- [Revision History](front-matter/revision-history.md)
- [Review History](front-matter/review-history.md)

### 2. Normative Chapters
- [Chapter 1: Purpose & Scope](chapters/purpose-and-scope.md)
...
- [Annex B: Editorial Style Guide](annexes/editorial-style-guide.md)
- [Annex C: Governance Record Templates](annexes/governance-record-templates.md)
- [Annex D: Lifecycle Examples](annexes/lifecycle-examples.md)
- [Annex E: Repository Structure Reference](annexes/repository-structure-reference.md)
