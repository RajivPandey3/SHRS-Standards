...
## 6.1 Publication Artifacts
A Publication Artifact is any generated document (such as a PDF, HTML page, or Markdown file) that represents the approved Standard. 
- All Publication Artifacts SHALL be directly generated from the Canonical Source without manual alteration.
- Any discrepancy between the Canonical Source and a Publication Artifact MUST be resolved in favor of the Canonical Source.
